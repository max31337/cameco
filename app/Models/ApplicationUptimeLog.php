...
/**
 * Application Uptime Log Model
 * 
 * Tracks application uptime/downtime and availability.
 * Used for monitoring application SLA compliance and service availability.
 */
class ApplicationUptimeLog extends Model
{
    use HasFactory;

    protected $table = 'application_uptime_logs';
