...
/**
 * Application Patch Model
 *
 * Tracks patches/updates.
 * Used for monitoring patch deployment schedules and compliance.
 */
class ApplicationPatch extends Model
{
    use HasFactory, SoftDeletes;

    protected $table = 'application_patches';
