...
class StoreEmployeeRequest extends FormRequest
{
    ...
    {
        return [
            // Personal Information (Profile data - auto-created)
            ...
            'employment_type' => ['required', 'string', 'in:regular,probationary,contractual,project-based,part-time'],
            ...
            'status' => ['required', 'string', 'in:active,on_leave,suspended,terminated,archived'],
